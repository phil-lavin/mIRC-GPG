...
2) Copy gpg.mrc and mEnv.dll into the directory you normally place your mIRC scripts
3) Open your script editor by pressing Alt + R when in mIRC
4) Go to File->Load and locate gpg.mrc
5) You will be presented with a box asking for the directory path to gpg.exe. Enter this and click OK
